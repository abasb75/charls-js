...
// dist/jls_encoder.js
var require_jls_encoder = __commonJS({
  "dist/jls_encoder.js"(exports2, module2) {
    "use strict";
    var CharLSEncoder2 = (() => {
      ...
      return async function(moduleArg = {}) {
        ...
        function findWasmBinary() {
          return locateFile("jls_encoder.wasm");
        }
...
`;
  ...
  ${functionBody}
        ...
        Module["ccall"] = ccall;
        var ___getTypeName, _free, _malloc, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable;
        function assignWasmExports(wasmExports2) {
          ___getTypeName = wasmExports2["y"];
          _free = wasmExports2["z"];
          _malloc = wasmExports2["B"];
          __emscripten_stack_restore = wasmExports2["C"];
          __emscripten_stack_alloc = wasmExports2["D"];
          _emscripten_stack_get_current = wasmExports2["E"];
          memory = wasmMemory = wasmExports2["w"];
          __indirect_function_table = wasmTable = wasmExports2["A"];
        }
        var wasmImports = { d: ___cxa_throw, p: __abort_js, m: __embind_register_bigint, t: __embind_register_bool, r: __embind_register_emval, l: __embind_register_float, n: __embind_register_function, b: __embind_register_integer, a: __embind_register_memory_view, s: __embind_register_std_string, h: __embind_register_std_wstring, u: __embind_register_void, g: __emval_create_invoker, c: __emval_decref, v: __emval_get_property, k: __emval_incref, f: __emval_invoke, i: __emval_new_cstring, o: __emval_new_object, e: __emval_run_destructors, j: __emval_set_property, q: _emscripten_resize_heap };
        function run() {
          preRun();
          function doRun() {
    ...
    if (typeof exports2 === "object" && typeof module2 === "object") {
      module2.exports = CharLSEncoder2;
      module2.exports.default = CharLSEncoder2;
    } else if (typeof define === "function" && define["amd"]) define([], () => CharLSEncoder2);
  }
});
...
var import_jls_encoder = __toESM(require_jls_encoder());
var charls;
var encodeImage = null;
async function decode(imageData, width, height, components, bitsPerSample, interleaveMode = -1, nearLossless = 0) {
  if (!charls) {
    charls = await (0, import_jls_encoder.default)();
