...
// dist/jls_decoder.js
var require_jls_decoder = __commonJS({
  "dist/jls_decoder.js"(exports2, module2) {
    "use strict";
    var CharLSDecoder2 = (() => {
      ...
      return async function(moduleArg = {}) {
        ...
        function findWasmBinary() {
          return locateFile("jls_decoder.wasm");
        }
...
`;
  ...
  ${functionBody}
    ...
    if (typeof exports2 === "object" && typeof module2 === "object") {
      module2.exports = CharLSDecoder2;
      module2.exports.default = CharLSDecoder2;
    } else if (typeof define === "function" && define["amd"]) define([], () => CharLSDecoder2);
  }
});
...
var import_jls_decoder = __toESM(require_jls_decoder());
var charls;
async function decode(imageData) {
  if (!charls) {
    charls = await (0, import_jls_decoder.default)();
  }
