...
// dist/jls_es6_decoder.js
async function CharLSDecoder(moduleArg = {}) {
  var moduleRtn;
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("jls_es6_decoder.wasm");
    }
    return new URL("jls_es6_decoder.wasm", import.meta.url).href;
  }
...
var jls_es6_decoder_default = CharLSDecoder;

// dist/decode.ts
var charls;
async function decode(imageData) {
  if (!charls) {
    charls = await jls_es6_decoder_default({
      locateFile: (path) => {
